...
import 'package:atlas_flutter/widgets/number_picker.dart';
import 'package:atlas_flutter/widgets/reps_editor.dart';
import 'package:atlas_flutter/widgets/rpe_editor.dart';
            ...
            AnimatedContainer(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, index) => index == 2
                    ? const RepsEditor()
                    : index == 3
                        ? NumberPickerWidget(onNumberSelected: (index) {})
                        : const RPEEditor(),
              ),
            ),
          ],
